...
const MainContent = () => {
    const womp = "bold";
    return (
        <main className="mx-5 mt-5 mb-10 flex-row space-y-10">
            ...
            <div className="text-2xl border-amber-500 border-2 rounded-2xl p-4">
                {/* <div className="p-1 bg-white float-left mr-4 rounded-2xl"> */}
                {/* <img src="kpplogo.png" className="h-20 float-left mr-5"/> */}
                {/* </div> */}
                <p>Karpportal is a social-media platform I developed in Flutter and dart with firebase for the backend. The project aims to provide an app where pepople can post about their favourite stuff and communicate with each other. Some notable features of the app are, end to end encryption, group chats and high color customization.</p>
            </div>
            ...
            <div className="text-2xl border-indigo-500  border-2 rounded-2xl p-4 space-y-5">
                <p >
                    <span className="high-indigo">Midi-b</span>
                </p>
                <p>
                </p>
            </div>
